import cleancode.airport.Airport;
import cleancode.planes.ExperimentalPlane;
import cleancode.classification.ClassificationLevel;
import cleancode.models.ExperimentalType;
...
public class AirportTest {
    private static List<Plane> planes = Arrays.asList(
            ...
            new ExperimentalPlane("Ryan X-13 Vertijet", 560, 307, 500, ExperimentalType.VERTICAL_TAKE_OFF, ClassificationLevel.TOP_SECRET)
    );
    ...
    public void testGetPassengerPlaneWithMaxCapacity() {
        Assert.assertEquals(planeWithMaxPassengerCapacity, new Airport(planes).getMaxPassengersCapacityPlane());
    }

    @Test
    public void testLoadCapasity() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public void testExperimentalPlanesLevelsComparsion() {
        Airport airport = new Airport(planes);
